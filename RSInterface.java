...
public class RSInterface {
	...
	public static void questTab(TextDrawingArea[] tda) {
		...
		addText(10221, "@cr10@@or1@ Game Panel", tda, 2, 16750899, false, true);
		addText(10222, "@or1@"+Configuration.WEBSITE_LINK, tda, 2, 16750899, true, true);
		addSprite(10224, 0, "Interfaces/infoTab/SPRITE");
		addButton(10404, 4, "Interfaces/infoTab/TAB", "Wilderness Tasks");
		...
		tab.child(4, 10223, 0, 32);
		tab.child(5, 10280, 2, 34);
		tab.child(6, 10404, 172, 15);
		RSInterface serverStatics = addTabInterface(10280);
		serverStatics.height = 196;
		serverStatics.width = 172;
		serverStatics.scrollMax = 365;
		serverStatics.newScroller = false;

		addText(10406, "@or1@Quick Links", tda, 2, 16750899, false, true);
		addHoverText(10407, "@or1@Website@gre@0", "visit", tda, 0, 1022259, false, true, 150);
		addHoverText(10408, "@or1@Forums@gre@0", "visit", tda, 0, 1022259, false, true, 150);
		addHoverText(10409, "@or1@Donate@red@None", "visit", tda, 0, 1022259, false, true, 150);
		addHoverText(10410, "@or1@Vote@red@None ", "visit", tda, 0, 1022259, false, true, 150);
		addText(10412, "@or1@Server Statistics", tda, 2, 16750899, false, true);
		addText(10413, "@or1@Player Statistics", tda, 2, 16750899, false, true);

		serverStatics.totalChildren(19);
		serverStatics.child(0, 10406, 1, 3);
        serverStatics.child(1, 10407, 1, 25);
        serverStatics.child(2, 10408, 1, 41);
        serverStatics.child(3, 10409, 1, 57);
        serverStatics.child(4, 10410, 1, 73);
        serverStatics.child(5, 10412, 1, 105);
        serverStatics.child(6, 10413, 1, 196);

		int Ypos = 125;
		int frameID = 7;
		for (int iD = 10225; iD <= 10228; iD++) {
			addHoverText(iD, "", "View", tda,
					0, 16711680, false, true, 150);
			serverStatics.child(frameID, iD, 1, Ypos);
			frameID++;
			Ypos += 13;
			Ypos++;
		}
	...
	public static void bank(TextDrawingArea[] tda) {
		...
		addHover(5384, 3, 0, 5380, 1, "Bank/BANK", 25, 25,
				"Close Window");
		//
		...
		addText(24055, "Note", tda, 1, 16750623, true, true);
		setBounds(24055, 316, 307, 45, Interface);

		addBankHover1(22012, 5, 22013, 17, "Bank/BANK", 36, 36,
		...
		addBankHover1(22016, 5, 22017, 19, "Bank/BANK", 36, 36,
		...
		addBankHover1(23020, 5, 23021, 21, "Bank/BANK", 36, 36,
		...
		addText(22043, "__", tda, 0, 16750623, true, true);
		setBounds(22043, 30, 10, 37, Interface);
		addSprite(22044, 24, "Bank/BANK");
		setBounds(22044, 463, 42, 38, Interface);
		addText(22045, "Withdraw as:", tda, 1, 16750623, true, true);
		setBounds(22045, 283, 290, 39, Interface);
		addText(22046, "Rearrange mode:", tda, 1, 16750623, true, true);
